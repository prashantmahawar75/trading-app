import { app, TICKER } from "../trading_back/index";
...
describe("Basic tests", () => {
  ...
  it("Can create tests", async () => {
    ...
    expect(res.status).toBe(200); // check if depth endpoint is working
    expect(res.body.depth["1501"].quantity).toBe(5); // check hi hai
